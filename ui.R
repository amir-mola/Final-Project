  ...
  tabPanel(
    ...
    tags$div(
      ...
      tags$p("This report demonstrates an overview of movie titles, popularities,
              ...
              regarding highly rated movies so that the viewer can see which
              year released multiple hits, which genres are popular, and which
              movie they should watch given their preferences. We believe that
              the production side of the movie industry could heavily benefit
